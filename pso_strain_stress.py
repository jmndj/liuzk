...
class PSO():                                                  #定义一个类
    def __init__(self,costFunc,x0,bounds,num_particles,maxiter):
        ...
        # 将所有粒子初始化                  
        swarm[0].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[1].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[2].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[3].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[4].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[5].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[6].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[7].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[8].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[9].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[10].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[11].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[12].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[13].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[14].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[15].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[16].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[17].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[18].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
        swarm[19].position_i=[random.uniform(-10,10),random.uniform(-10,10),random.uniform(-10,10)]
